...
export default function AddEmployeeDialog({ open, onClose }) {
    ...
    const { createNewEmployee } = useUsers();
    ...
    const onSubmit = async (data) => {
        ...
        try {
            const res = await createNewEmployee.mutateAsync({ data })
            console.log(res);
            onClose();
            reset();
        } catch (error) {
        ...
        >
            ...
            <Box component="form" noValidate onSubmit={handleSubmit(onSubmit)}>
                ...
                <DialogActions>
                    ...
                    <Button variant="contained" type="submit" loading={createNewEmployee?.isPending}>
                        Save
                    </Button>
                </DialogActions>
            </Box>
