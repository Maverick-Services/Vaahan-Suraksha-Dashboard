...
export default function EmployeesTable({ apiData, onPageChange, limit, setLimit, dataLoading, onEdit }) {
    ...
    const pageLimit = apiData?.pagination?.limit || limit || 10;
                                            ...
                                            <TableCell>
                                                <Switch
                                                    ...
                                                    onChange={(e) => {
                                                        ...
                                                        // TODO: implement toggle mutation (optimistic update recommended)
                                                    }}
                                                    color="primary"
                                                />
                                            </TableCell>
